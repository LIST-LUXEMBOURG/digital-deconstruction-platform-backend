...
export class CreateProjectParticipantParamsDto extends WithParams(class { }) { }
export class CreateProjectParticipantBodyDto extends WithBody(class { }) { }
export class CreateProjectParticipantDto extends WithBody(
