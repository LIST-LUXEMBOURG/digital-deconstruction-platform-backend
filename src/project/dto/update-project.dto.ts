...
import { ProjectAddressUpdateDto } from './address/updateProjectAddress.dto';
...
export function WithBody<TBase extends Constructor>(Base: TBase) {
    class Body extends Base {
        ...
        @ApiProperty({
            required: false,
            type: ProjectAddressUpdateDto,
            description: "The full street address of the project",
        })
        @ValidateNested()
        fullAddress?: ProjectAddressUpdateDto;
    }
    return Body;
}
export class UpdateProjectParamsDto extends WithProjectId(class { }) { }
export class UpdateProjectBodyDto extends WithBody(class { }) { }
export class UpdateProjectDto extends WithBody(
