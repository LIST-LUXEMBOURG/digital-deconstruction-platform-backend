...
export class CreateInventoryMaterialTypeParamsDto extends WithProjectId(class { }) { }
export class CreateInventoryMaterialTypeBodyDto extends WithBody(class { }) { }
export class CreateInventoryMaterialTypeDto extends WithBody(
