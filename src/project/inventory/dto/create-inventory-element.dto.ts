...
export class CreateInventoryElementParamsDto extends WithProjectId(class { }) { }
export class CreateInventoryElementBodyDto extends WithBody(class { }) { }
export class CreateInventoryElementDto extends WithBody(
