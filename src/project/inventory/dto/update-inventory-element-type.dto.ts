...
export class UpdateInventoryElementTypeBodyDto extends WithBody(class { }) { }
export class UpdateInventoryElementTypeParamsDto extends WithParams(class { }) { }
export class UpdateInventoryElementTypeDto extends WithBody(
