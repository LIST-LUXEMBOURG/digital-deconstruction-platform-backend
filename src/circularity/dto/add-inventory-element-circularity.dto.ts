...
export class AddInventoryElementCircularityBodyDto extends WithParams(class { }) { }
export class AddInventoryElementCircularityParamsDto extends WithParams(class { }) { }
export class AddInventoryElementCircularityDto extends WithParams(Authorization) { }