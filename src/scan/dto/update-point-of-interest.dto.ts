...
function WithParams<TBase extends Constructor>(Base: TBase) {
    class Params extends WithProjectId(Base) {
        @ApiProperty({
            type: String,
            required: true,
            description: 'The unique identifier of an point of interest',
        })
        @IsUUID()
        @IsNotEmpty()
        ...
        //     type: String,
        //     required: true,
        //     description: 'The unique identifier of the element this point of interest is attached to',
        // })
        // @IsUUID()
        // @IsNotEmpty()
        // elementUid: string;
...
export class UpdatePointOfInterestBodyDto extends WithBody(class { }) { }
export class UpdatePointOfInterestParamsDto extends WithParams(class { }) { }
export class UpdatePointOfInterestDto extends WithBody(
